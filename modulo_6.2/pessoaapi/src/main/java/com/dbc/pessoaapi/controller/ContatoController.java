...
//    }
    ...
    @GetMapping("/buscar-contato-com-id-pessoa-com-query-nativa")
    List<ContatoEntity> findByContatoComIdPessoaComQueryNativa(@RequestParam("tipo") Integer id){
        return contatoRepository.findByContatoComIdPessoaComQueryNativa(id);
    }
